...
public class CommentHandling {
     ...
     * @return 
     */
    public  List<YoutubeSearchComments> SearchVideoComment(String videoId,String text) {
        ...
        try {
            ...
            List<YoutubeSearchComments> searchCommentList=new ArrayList<YoutubeSearchComments>();
            ...
            if (videoComments.isEmpty()) {
                ...
                for (CommentThread videoComment : videoComments) {
                    ...
                    System.out
                            .println("\n-------------------------------------------------------------\n");
                    YoutubeSearchComments searchComment = createCommentData(snippet);
    ...
    private YoutubeSearchComments createCommentData(CommentSnippet snippet) {
    	YoutubeSearchComments searchComment = new YoutubeSearchComments();
    	searchComment.setAuthorChannelId(snippet.getAuthorChannelId()!=null?snippet.getAuthorChannelId().getValue():"");
    	searchComment.setAuthorChannelUrl(snippet.getAuthorChannelUrl());
    	searchComment.setAuthorDisplayName(snippet.getAuthorDisplayName());
    	searchComment.setAuthorGoogleplusProfileUrl(snippet.getAuthorGoogleplusProfileUrl());
    	searchComment.setTextDisplay(snippet.getTextDisplay());
    	searchComment.setViewerRating(snippet.getViewerRating());
    	searchComment.setLikeCount(snippet.getLikeCount());
    	searchComment.setPublishedAt(snippet.getPublishedAt());
